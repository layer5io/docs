...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: 'c7bbe04b-ade2-427a-a563-62ae75c19002',
          label: 'service-account-ar',
          type: 'ServiceAccount',
          version: 'v1.25.2',
          apiVersion: 'v1',
          meshType: 'kubernetes',
          model: 'kubernetes',
          config: {
            name: 'service-account-ar',
            services: {
              'c7bbe04b-ade2-427a-a563-62ae75c19002': {
                namespace: 'default',
                settings: { name: 'service-account-ar', namespace: 'default' },
                traits: {
                  meshmap: {
                    edges: [
                      {
                        data: {
                          ...
                          id: 'b9264642-73cc-49f0-94a4-9d4b7c634892',
                          metadata: {
                            binded_by: 'd1b4e329-e38d-4d6d-9491-98787e00cc06',
                          },
                          source: '17b86312-e5ca-476b-ab13-3d29d1c8bc50',
                          subType: 'Permission',
                          target: 'c7bbe04b-ade2-427a-a563-62ae75c19002',
                        },
                        style: {
                          'curve-style': {
                            bypass: true,
                    ...
                    position: {
                      posX: 134.12630508412846,
                      posY: -23.037755292484178,
                    },
                    whiteboardData: { style: { 'z-index': 8 } },
                  },
                },
                type: 'ServiceAccount',
              },
          ...
          hangingSvg:
            'url(http://localhost:9081/ui/public/static/img/meshmodels/kubernetes/color/kubernetes-color.svg)',
        },
        position: { x: 134.12630508412846, y: -23.037755292484178 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: '38a07af4-6de5-4c08-96ec-283d8844251c',
          label: 'api-service-dd',
          type: 'APIService',
          version: 'v1.25.4',
          ...
          config: {
            name: 'api-service-dd',
            services: {
              '38a07af4-6de5-4c08-96ec-283d8844251c': {
                settings: { name: 'api-service-dd' },
                traits: {
                  meshmap: {
                    edges: [],
                    id: '38a07af4-6de5-4c08-96ec-283d8844251c',
                    ...
                    'meshmodel-metadata': {
                      ...
                      shape: 'triangle',
                      styleOverrides:
                        '{"height":"23px","width":"23px","x":"7", "y":"14"}',
                      subCategory: 'Scheduling & Orchestration',
                      svgColor:
                        'ui/public/static/img/meshmodels/kubernetes/color/apiservice-color.svg',
                      svgComplete: '',
                      svgWhite:
                        'ui/public/static/img/meshmodels/kubernetes/white/apiservice-white.svg',
                    },
                    position: {
                      posX: -83.13531948445181,
                      posY: 65.7249515451062,
                    },
        ...
        position: { x: -83.13531948445181, y: 65.7249515451062 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: 'd1b4e329-e38d-4d6d-9491-98787e00cc06',
          label: 'cluster-role-binding-uc',
          ...
          model: 'kubernetes',
          config: {
            name: 'cluster-role-binding-uc',
            services: {
              'd1b4e329-e38d-4d6d-9491-98787e00cc06': {
                settings: {
                  'role Ref': {
                    'api Group': 'rbac.authorization.k8s.io/v1',
                    kind: 'ClusterRole',
                    name: 'cluster-role-ho',
                  },
                  subjects: [
                    { kind: 'ServiceAccount', name: 'service-account-ar' },
                  ],
                  name: 'cluster-role-binding-uc',
                },
                traits: {
                  meshmap: {
                    ...
                    position: {
                      posX: 69.76316907302052,
                      posY: -22.156000081402784,
                    },
                    whiteboardData: { style: { 'z-index': 9 } },
                  },
                },
                type: 'ClusterRoleBinding',
              },
        ...
        position: { x: 69.76316907302052, y: -22.156000081402784 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: '17b86312-e5ca-476b-ab13-3d29d1c8bc50',
          label: 'cluster-role-ho',
          type: 'ClusterRole',
          version: 'v1.25.2',
          apiVersion: 'rbac.authorization.k8s.io/v1',
          meshType: 'kubernetes',
          ...
          config: {
            name: 'cluster-role-ho',
            services: {
              '17b86312-e5ca-476b-ab13-3d29d1c8bc50': {
                settings: {
                  rules: [{ resources: ['ServiceAccount'], verbs: ['get'] }],
                  name: 'cluster-role-ho',
                },
                traits: {
                  meshmap: {
                    ...
                    position: {
                      posX: 5.187459172686558,
                      posY: -21.27133267327536,
                    },
        ...
        position: { x: 5.187459172686558, y: -21.27133267327536 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: '10f19fdb-07f3-4370-901e-766b2fab5f9c',
          label: 'default',
          type: 'Namespace',
          version: 'v1.25.2',
          apiVersion: 'v1',
          ...
          config: {
            name: 'default',
            services: {
              '10f19fdb-07f3-4370-901e-766b2fab5f9c': {
                ...
                traits: {
                  meshmap: {
                    ...
                    position: {
                      posX: -84.46054341009133,
                      posY: -17.127039477004757,
                    },
        ...
        position: { x: -84.46054341009133, y: -17.127039477004757 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: { weight: 75, id: '19ae6f89-2fcb-4263-88fa-55c066c5d2f0' },
        position: { x: -84.46054341009133, y: -17.127039477004757 },
        group: 'nodes',
        removed: false,
        selected: false,
      ...
      {
        data: {
          id: '929b8313-7dd5-4573-aaa3-55d1cff3313e',
          label: 'pod-lx',
          type: 'Pod',
          version: 'v1.25.2',
          apiVersion: 'v1',
          ...
          config: {
            name: 'pod-lx',
            services: {
              '929b8313-7dd5-4573-aaa3-55d1cff3313e': {
                namespace: 'default',
                settings: { name: 'pod-lx', namespace: 'default' },
                traits: {
                  meshmap: {
                    edges: [],
                    id: '929b8313-7dd5-4573-aaa3-55d1cff3313e',
                    ...
                    parent: '10f19fdb-07f3-4370-901e-766b2fab5f9c',
                    position: {
                      posX: -84.46054341009133,
                      posY: -26.127039477004757,
                    },
                    whiteboardData: { style: { 'z-index': 4 } },
                  },
                },
                type: 'Pod',
              },
        ...
        position: { x: -84.46054341009133, y: -26.127039477004757 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
    ...
    edges: [
      {
        data: {
          bindingComponent: 'ClusterRoleBinding',
          id: 'b9264642-73cc-49f0-94a4-9d4b7c634892',
          metadata: { binded_by: 'd1b4e329-e38d-4d6d-9491-98787e00cc06' },
          source: '17b86312-e5ca-476b-ab13-3d29d1c8bc50',
          subType: 'Permission',
          target: 'c7bbe04b-ade2-427a-a563-62ae75c19002',
        },
  ...
  elementStyles: {
    'c7bbe04b-ade2-427a-a563-62ae75c19002': {
      ...
      borderStyle: 'solid',
      'background-image':
        'url(data:image/svg+xml;base64,)',
      backgroundImage:
        'url(data:image/svg+xml;base64,)',
    ...
    'd1b4e329-e38d-4d6d-9491-98787e00cc06': {
      ...
      borderStyle: 'solid',
      'background-image':
        'url(data:image/svg+xml;base64,)',
      backgroundImage:
        'url(data:image/svg+xml;base64,)',
      'background-image-crossorigin': 'anonymous',
      backgroundImageCrossorigin: 'anonymous',
      ...
      'outside-texture-bg-opacity': '0.125',
      outsideTextureBgOpacity: '0.125',
      content: 'cluster-role-binding-uc',
      'control-point-weight': '0.5',
      controlPointWeight: '0.5',
      'edge-text-rotation': 'none',
      edgeTextRotation: 'none',
    ...
    '17b86312-e5ca-476b-ab13-3d29d1c8bc50': {
      ...
      borderStyle: 'solid',
      'background-image':
        'url(data:image/svg+xml;base64,)',
      backgroundImage:
        'url(data:image/svg+xml;base64,)',
      'background-image-crossorigin': 'anonymous',
      backgroundImageCrossorigin: 'anonymous',
    ...
    '19ae6f89-2fcb-4263-88fa-55c066c5d2f0': {
      events: 'yes',
      'text-events': 'no',
      textEvents: 'no',
      'transition-property': 'none',
      ...
      'target-text-offset': '0px',
      targetTextOffset: '0px',
      height: '39.375306250000015',
      width: '39.375306250000015',
      shape: 'ellipse',
      'shape-polygon-points': '-1 -1 1 -1 1 1 -1 1',
      shapePolygonPoints: '-1 -1 1 -1 1 1 -1 1',
      ...
      'background-blacken': '0',
      backgroundBlacken: '0',
      'background-gradient-stop-colors': 'rgb(206,212,218) rgb(222,226,230)',
      backgroundGradientStopColors: 'rgb(206,212,218) rgb(222,226,230)',
      'background-gradient-stop-positions': '0%',
      backgroundGradientStopPositions: '0%',
      'background-gradient-direction': 'to-bottom',
      backgroundGradientDirection: 'to-bottom',
    ...
    'b9264642-73cc-49f0-94a4-9d4b7c634892': {
      events: 'yes',
      'text-events': 'yes',
      textEvents: 'yes',
      'transition-property': 'none',
      ...
      'line-style': 'dotted',
      lineStyle: 'dotted',
      'line-color': 'rgb(122,161,240)',
      lineColor: 'rgb(122,161,240)',
      'line-fill': 'solid',
      lineFill: 'solid',
      'line-cap': 'butt',
      lineCap: 'butt',
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c .embed-canvas-container {
        height: 100%;
        width: 100%;
    }


    #embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c {
      /* Dark theme */
   ...
   #embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c .water-mark{
    ...
    #embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c .toolbar {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  cyContainer.id = 'embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c-cy';
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      'embedded-design-abedbfc6-2a46-4866-99d4-1f9eadd90d0c-cy',
    ),
