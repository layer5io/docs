...
![Navigate to Actions button](/kanvas/getting-started/images/validating-designs/performing-validation-1.png)

2. Click on the **Validate** Icon.

![Click on the Validate icon](/kanvas/getting-started/images/validating-designs/performing-validation-2.png)
