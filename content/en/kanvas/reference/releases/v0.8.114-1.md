...
- NOTICE: This div is used by layer5labs/kanvas-snapshot to capture the contents
  of the canvas. @leecalcote (#3799)
...
- refactor: improve structure and error handling in webpack-dev-server
  @leecalcote (#3793)
- fix: correct casing in type annotations and improve variable declarations
  @leecalcote (#3792)
- [CI] Chore: rm capabilities.json; enhance meshmap-userpref watch.json
  @leecalcote (#3791)
