...
- build(deps-dev): bump eslint-plugin-react from 7.33.2 to 7.37.1 in /meshmap
  @dependabot (#2993)
- build(deps-dev): bump css-loader from 6.8.1 to 7.1.2 in /meshmap @dependabot
  (#2994)
...
- [CI] Enhance to use full base+extension versioning (Attempt #2) @leecalcote
  (#3001)
...
@aabidsofi19, @amitamrutiya, @dependabot, @dependabot[bot], @l5io and
@leecalcote
