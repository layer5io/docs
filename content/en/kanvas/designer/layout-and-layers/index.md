...
![Layers panel listing annotations, configurable components, badges, and component kinds](../images/audit-2026-09/designer-configurator.png)
*Layers panel (anonymous capture, Sep 2026): By Type, Component Badges, and Components. Filename in the audit set is historical — this shot is the Layers drawer, not the per-component configurator.*
