...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: '7abddb49-01f6-434b-ab64-44374125f2a3',
          label: 'default\n (Namespace)',
          schemaId: 'components.meshery.io/v1beta1',
        },
        position: { x: 1208.9366357279046, y: 569.6167283810951 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
        ...
        grabbable: true,
        pannable: false,
        classes: 'cdnd-grabbed-node cdnd-drop-target',
      },
      {
        data: {
          id: '6fd4ade0-6690-4339-8339-39fe348da8e3',
          label: 'ingress-xc\n (Ingress)',
          schemaId: 'components.meshery.io/v1beta1',
          parent: '7abddb49-01f6-434b-ab64-44374125f2a3',
        },
        position: { x: 1268.6703732630133, y: 605.5472570544666 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: '8f6ff017-a982-42ba-9c7a-f95c1e826d08',
          label: 'service-jr\n (Service)',
          schemaId: 'components.meshery.io/v1beta1',
          parent: '7abddb49-01f6-434b-ab64-44374125f2a3',
        },
        position: { x: 1149.7028981927956, y: 511.68619970772346 },
        group: 'nodes',
        removed: false,
        selected: false,
        selectable: true,
    ...
    edges: [
      {
        data: {
          id: '8ce89327-179e-4a28-b70c-5fb108e7bc1b',
          source: '6fd4ade0-6690-4339-8339-39fe348da8e3',
          target: '8f6ff017-a982-42ba-9c7a-f95c1e826d08',
        },
        position: { x: -38.530245696626885, y: 2.7708835704377655 },
        group: 'edges',
        removed: false,
        selected: false,
        selectable: true,
  ...
  elementStyles: {
    '7abddb49-01f6-434b-ab64-44374125f2a3': {
      events: 'yes',
      'text-events': 'no',
      textEvents: 'no',
    ...
    '6fd4ade0-6690-4339-8339-39fe348da8e3': {
      events: 'yes',
      'text-events': 'no',
      textEvents: 'no',
      'transition-property': 'none',
    ...
    '8f6ff017-a982-42ba-9c7a-f95c1e826d08': {
      events: 'yes',
      'text-events': 'no',
      textEvents: 'no',
      'transition-property': 'none',
    ...
    '8ce89327-179e-4a28-b70c-5fb108e7bc1b': {
      events: 'yes',
      'text-events': 'yes',
      textEvents: 'yes',
      'transition-property': 'none',
      ...
      'source-text-offset': '0px',
      sourceTextOffset: '0px',
      'target-label': 'service-jr',
      targetLabel: 'service-jr',
      'target-text-rotation': 'none',
      targetTextRotation: 'none',
      'target-text-margin-x': '0px',
      targetTextMarginX: '0px',
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    'embedded-design-d0a031d0-b4d7-4d60-be17-c4b5d2480ee6',
  );
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      'embedded-design-d0a031d0-b4d7-4d60-be17-c4b5d2480ee6-cy',
    ),
