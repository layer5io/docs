...
- Ensure that systemCommitSHA is not displayed if it is an empty string.
  @leecalcote (#3870)
- [Chore]: Update to Sistent v0.14.212 manually @FaheemOnHub (#3872)
- Add:Frontmatter generator in own learningPath && migrate ownLearningCard to
  cloud-ui (depends on sistent #1117) @FaheemOnHub (#3844)
