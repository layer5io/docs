...
- feat(docs): Add documentation for Component Badges in Designer Mode
  @zihanKuang (#3710)
- Bump @rjsf/validator-ajv8 from 5.24.10 to 5.24.12 in /ui @dependabot (#3714)
- [chore] Remove all use of 'successfully' in notifications to users'
  @leecalcote (#3728)
...
- Bump github.com/bradleyfalzon/ghinstallation/v2 from 2.11.0 to 2.16.0
  @dependabot (#3556)
- Bump eslint-config-next from 14.2.7 to 15.3.4 in /ui @dependabot (#3713)
...
@aabidsofi19, @dependabot, @dependabot[bot], @l5io, @leecalcote, @ritzorama and
@zihanKuang
