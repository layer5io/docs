...
- Update README.md with Setting up Development Environment on Metal Server
  @Namanv0509 (#3970)
- Update README and Makefile to remove the obsolete reference to db-keys-init
  @Vincamine (#3975)
...
@Vincamine, @aabidsofi19, @l5io, @leecalcote and @vr-varad
