...
When creating a new design by default it's visibility level will be set to __public__ unless you are an active Layer5 Cloud subscriber, in which case you can change this default to __private__. 
