...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "211155a6-49c3-456e-bff3-e207f7367472",
          ...
          config: {
            ...
            services: {
              "211155a6-49c3-456e-bff3-e207f7367472": {
                settings: {
                  spec: {
                    group: "dapr.io",
                    names: {
                      kind: "HTTPEndpoint",
                      "list Kind": "HTTPEndpointList",
                          ...
                          "open APIV3Schema": {
                            ...
                            properties: {
                              ...
                              auth: {
                                ...
                                properties: { "secret Store": { type: "string" } },
                  ...
                  name: "httpendpoints.dapr.io",
                  labels: { "app.kubernetes.io/part-of": "dapr" }
                },
                traits: {
                  meshmap: {
                    edges: [],
                    ...
                    "meshmodel-metadata": {
                      ...
                      shapePolygonPoints: "",
                      status: "enabled",
                      styleOverrides: { "z-index": 1032 },
                      styles: "",
                      subCategory: "",
                      svgColor:
                        "ui/public/static/img/meshmodels/kubernetes/color/customresourcedefinition-color.svg",
                      svgComplete: "",
                      svgWhite:
                        "ui/public/static/img/meshmodels/kubernetes/white/customresourcedefinition-white.svg"
                    },
                    position: { posX: 608.3894897141281, posY: 360.25465896620716 },
        ...
        position: { x: 608.3894897141281, y: 360.25465896620716 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "e62926ff-bf42-4997-8608-334b42b26580",
          type: "CustomResourceDefinition",
          apiVersion: "apiextensions.k8s.io/v1",
          meshType: "kubernetes",
          model: "kubernetes",
          config: {
            ...
            services: {
              "e62926ff-bf42-4997-8608-334b42b26580": {
                settings: {
                  spec: {
                    group: "dapr.io",
                    names: {
                                  ...
                                  targets: {
                                    properties: {
                                      actors: {
                                        additionalProperties: {
                                          properties: {
                                            "circuit Breaker": { type: "string" },
                                            "circuit Breaker Cache Size": {
                                              type: "integer"
                                            },
                                            "circuit Breaker Scope": { type: "string" },
                                            retry: { type: "string" },
                                            timeout: { type: "string" }
                                          },
                                          type: "object"
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 548.5054272590844, posY: 195.322235233187 },
                    whiteboardData: { style: {} }
                  }
                },
                type: "CustomResourceDefinition"
        ...
        position: { x: 548.5054272590844, y: 195.322235233187 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "ee72071f-290a-4961-966d-9096ce4c1273",
          type: "CustomResourceDefinition",
          apiVersion: "apiextensions.k8s.io/v1",
          meshType: "kubernetes",
          model: "kubernetes",
          config: {
            ...
            services: {
              "ee72071f-290a-4961-966d-9096ce4c1273": {
                settings: {
                  spec: {
                    conversion: {
                      strategy: "Webhook",
                      webhook: {
                        ...
                        "conversion Review Versions": ["v1", "v2alpha1"]
                      }
                    },
                    group: "dapr.io",
                    names: {
                          ...
                          "open APIV3Schema": {
                            ...
                            properties: {
                              ...
                              spec: {
                                ...
                                properties: {
                                  "bulk Subscribe": {
                                    ...
                                    properties: {
                                      ...
                                      "max Await Duration Ms": { type: "integer" },
                                      "max Messages Count": { type: "integer" }
                                    },
                                    required: ["enabled"],
                                    type: "object"
                                  },
                                  "dead Letter Topic": { type: "string" },
                                  metadata: {
                                    additionalProperties: { type: "string" },
                                    type: "object"
                                  },
                                ...
                                required: ["pubsubname", "route", "topic"],
                                type: "object"
                              }
                            },
                            type: "object"
                          ...
                          "open APIV3Schema": {
                            ...
                            properties: {
                              ...
                              spec: {
                                ...
                                required: ["pubsubname", "routes", "topic"],
                                type: "object"
                              }
                            },
                            type: "object"
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 601.5201865278317, posY: 268.60289512375624 },
                    whiteboardData: { style: {} }
                  }
                },
                type: "CustomResourceDefinition"
        ...
        position: { x: 601.5201865278317, y: 268.60289512375624 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "2aba3320-f1ad-4bec-b29a-1be5011e10da",
          type: "CustomResourceDefinition",
          apiVersion: "apiextensions.k8s.io/v1",
          meshType: "kubernetes",
          model: "kubernetes",
          config: {
            ...
            services: {
              "2aba3320-f1ad-4bec-b29a-1be5011e10da": {
                settings: {
                  spec: {
                    group: "dapr.io",
                    names: {
                          ...
                          "open APIV3Schema": {
                            ...
                            properties: {
                              ...
                              spec: {
                                ...
                                required: ["metadata", "type", "version"],
                                type: "object"
                              }
                            },
                            type: "object"
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 490.64709666756, posY: 268.6966891855644 },
                    whiteboardData: { style: {} }
                  }
                },
                type: "CustomResourceDefinition"
        ...
        position: { x: 490.64709666756, y: 268.6966891855644 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "ce351c45-cd51-4211-984b-112cdc405549",
          type: "CustomResourceDefinition",
          apiVersion: "apiextensions.k8s.io/v1",
          meshType: "kubernetes",
          model: "kubernetes",
          config: {
            ...
            services: {
              "ce351c45-cd51-4211-984b-112cdc405549": {
                settings: {
                  spec: {
                    group: "dapr.io",
                    names: {
                      kind: "Configuration",
                      "list Kind": "ConfigurationList",
                              ...
                              spec: {
                                ...
                                properties: {
                                  ...
                                  mTLS: {
                                    ...
                                    properties: {
                                      "allowed Clock Skew": { type: "string" },
                                      "control Plane Trust Domain": { type: "string" },
                                      enabled: { type: "boolean" },
                                  ...
                                  "name Resolution": {
                                    ...
                                    required: ["component", "configuration", "version"],
                                    type: "object"
                                  },
                                  secrets: {
                                    description:
                                  ...
                                  tracing: {
                                    ...
                                    properties: {
                                      otel: {
                                        ...
                                        properties: {
                                          "endpoint Address": { type: "string" },
                                          "is Secure": { type: "boolean" },
                                          protocol: { type: "string" }
                                        },
                                        required: [
                                          "endpointAddress",
                                  ...
                                  wasm: {
                                    ...
                                    properties: { "strict Sandbox": { type: "boolean" } },
                                    type: "object"
                                  }
                                },
                                type: "object"
                  ...
                  name: "configurations.dapr.io",
                  labels: { "app.kubernetes.io/part-of": "dapr" },
                  annotations: { "controller-gen.kubebuilder.io/version": "v0.11.3" }
                },
                traits: {
                  meshmap: {
                    edges: [
                      {
                        data: {
                          id: "9332958f-b8e4-4482-bc16-6a454fcc3ce6",
                          source: "ce351c45-cd51-4211-984b-112cdc405549",
                          subType: "Annotation",
                          target: "d7a820d3-35e1-465d-acf6-2db813906825"
                        },
                        style: {
                    ...
                    position: { posX: 496.0299034975825, posY: 358.71250893735936 },
                    whiteboardData: { style: {} }
                  }
                },
                type: "CustomResourceDefinition"
        ...
        position: { x: 496.0299034975825, y: 358.71250893735936 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
      ...
      {
        data: {
          id: "d7a820d3-35e1-465d-acf6-2db813906825",
          type: "Configuration",
          ...
          config: {
            name: "daprsystem",
            services: {
              "d7a820d3-35e1-465d-acf6-2db813906825": {
                namespace: "default",
                settings: {
                  spec: {
                    mTLS: {
                  ...
                  labels: {
                    ...
                    "app.kubernetes.io/version": "1.13.0-rc.4"
                  }
                },
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 365.12945944500854, posY: 336.4854352817223 },
                    whiteboardData: { style: {} }
                  }
                },
                type: "Configuration"
        ...
        position: { x: 365.12945944500854, y: 336.4854352817223 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
  ...
  elementStyles: {
    ...
    "ce351c45-cd51-4211-984b-112cdc405549": {
      ...
      "outside-texture-bg-opacity": "0.125",
      outsideTextureBgOpacity: "0.125",
      content: "configurations.dapr.io",
      "control-point-weight": "0.5",
      controlPointWeight: "0.5",
      "edge-text-rotation": "none",
      edgeTextRotation: "none",
    ...
    "9332958f-b8e4-4482-bc16-6a454fcc3ce6": {
      events: "yes",
      "text-events": "yes",
      textEvents: "yes",
      "transition-property": "none",
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678 .embed-canvas-container {
        height: 100%;
        width: 100%;
        background-color: "inheirt";
    }
   #embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678 .water-mark{
    ...
    #embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678 .toolbar {
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678"
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  cyContainer.id = "embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678-cy";
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-7eed863e-a37c-493f-a7b6-61e4b29bb678-cy"
    ),
