...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "942be105-a41a-40af-bc98-808cdf386a09",
          label: "Component",
          type: "Component",
          version: "1.10.4",
          ...
          config: {
            name: "state-store",
            services: {
              "942be105-a41a-40af-bc98-808cdf386a09": {
                namespace: "default",
                settings: {
                  ...
                  spec: {
                    ...
                    metadata: [
                      {
                        name: "redisHost",
                        "secret Key Ref": { key: "redis", name: "redis-password" },
                ...
                traits: {
                  meshmap: {
                    ...
                    label: "Component",
                    "meshmodel-data": {
                      category: { metadata: null, name: "Serverless" },
                      components: null,
                      description: "",
                      displayName: "Dapr",
                      hostID: "26e64aa8-2d86-57bd-92b3-2a73160d27b4",
                      id: "b53eccf2-d651-5afb-88a0-26387cd31ebb",
                      metadata: {
                        isAnnotation: false,
                        source_uri: "https://wenerme.github.io/charts/dapr-1.12.3.tgz",
                        svgColor:
                          "ui/public/static/img/meshmodels/dapr/color/dapr-color.svg",
                        svgWhite:
                          "ui/public/static/img/meshmodels/dapr/white/dapr-white.svg"
                      },
                      model: { version: "1.10.4" },
                      name: "dapr",
                    ...
                    "meshmodel-metadata": {
                      ...
                      styleOverrides: {
                        ...
                        "background-image":
                          "url(https://playground.meshery.io/ui/public/static/img/meshmodels/dapr/white/component-white.svg)",
                    ...
                    position: { posX: -184.54261101613818, posY: -248.1110296798097 },
                    whiteboardData: {}
                  }
                },
                type: "Component"
        ...
        position: { x: -184.54261101613818, y: -248.1110296798097 },
        group: "nodes",
        removed: false,
        selected: false,
        selectable: true,
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8 .embed-canvas-container {
        height: 100%;
        width: 100%;
        background-color: "inheirt";
    }
   #embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8 .water-mark{
    ...
    #embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8 .toolbar {
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8"
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  cyContainer.id = "embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8-cy";
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-f0b9088c-ab17-41ee-9400-fcfc5f4d59a8-cy"
    ),
