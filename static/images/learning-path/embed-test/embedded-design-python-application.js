...
const data = {
  elements: {
    nodes: [
      {
        data: {
          id: "01acbf25-3211-46fd-8c40-c7e5ba41546f",
          type: "Deployment",
          apiVersion: "apps/v1",
          meshType: "kubernetes",
          model: "kubernetes",
          config: {
            name: "pythonapp",
            services: {
              "01acbf25-3211-46fd-8c40-c7e5ba41546f": {
                namespace: "default",
                settings: {
                  spec: {
                    replicas: 1,
      ...
      {
        data: {
          id: "c19ba597-76f9-4e28-ac53-b95e98b7b7e0",
          ...
          config: {
            name: "python",
            services: {
              "c19ba597-76f9-4e28-ac53-b95e98b7b7e0": {
                ...
                traits: {
                  meshmap: {
                    ...
                    parent: "01acbf25-3211-46fd-8c40-c7e5ba41546f",
...
const addStyles = () => {
  var css = ` 
    ...
    #embedded-design-03016ef6-7124-4169-a5c0-f403711d480d .embed-canvas-container {
        height: 100%;
        width: 100%;
        background-color: "inheirt";
    }
   #embedded-design-03016ef6-7124-4169-a5c0-f403711d480d .water-mark{
    ...
    #embedded-design-03016ef6-7124-4169-a5c0-f403711d480d .toolbar {
...
const CreateToolBar = () => {
  const cyContainer = document.getElementById(
    "embedded-design-03016ef6-7124-4169-a5c0-f403711d480d"
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  cyContainer.id = "embedded-design-03016ef6-7124-4169-a5c0-f403711d480d-cy";
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById(
      "embedded-design-03016ef6-7124-4169-a5c0-f403711d480d-cy"
    ),
